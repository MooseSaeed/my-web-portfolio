<header class="max-w-xl mx-auto mt-10 text-center ">
    ...
    <h2 data-aos="fade-up" data-aos-delay="100" data-aos-duration="400" data-aos-mirror="true" class="dark:text-black text-white inline-flex mt-3 items-center">
        By Mostafa Said
        <img class="wavingHand z-0" src="/images/wavinghand.png" width="35px" alt="Waving Hand" />
    </h2>

    <p data-aos="fade-up" data-aos-delay="200" data-aos-duration="400" data-aos-mirror="true" class="text-sm mt-3 text-white dark:text-black">
