<header class="max-w-xl mx-auto mt-10 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative flex lg:inline-flex items-center bg-blue-100 rounded-xl">
            <select class="border-none outline-hidden flex-1 appearance-none bg-transparent py-2 pl-3 pr-9 text-sm font-semibold">
        ...
        <div class=" flex lg:inline-flex items-center bg-blue-50 rounded-xl px-3 py-2">
            <form method="GET" action="#">
                <input type="text" name="search" placeholder="Looking for something?" class="bg-transparent placeholder-black text-sm border-none outline-hidden" />
            </form>
        </div>
    </div>
</header>